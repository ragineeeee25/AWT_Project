...
<div class="back-img back-img1">
   <div class="container divform">
      ...
      <form action="" method="post" name="f1" enctype="multipart/form-data">
         ...
         <div class="form-group">
            ...
            <input type="textarea" class="form-control" id="pr" name="a7" required value="<?php echo $row[8];?>">
         </div>
         <div class="form-group">
   ...
   <?php
      if ( isset( $_POST[ 'sub' ] ) ) 
      	...
      	$up = "update exhibition_events set 	event_name='$a', 	event_about='$b', 	event_category='$c', event_venue='$d', event_date='$e',event_time='$f', event_photo='$target_path', event_photo_disp='$target_path_disp' , g_url= '$g' where ex_id='$r'"; // this query for updating Exhibition & Events Details1
