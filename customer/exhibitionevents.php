   ...
   <div class="container-fluid">
      <div class="row">
         <?php
            ...
            Venue:  $result[4] <br/> Date $result[5] | Time $result[6]</span></div><div class='text-center'style='background:green;font-size: 20px;'><a href='google.php?id=$result[0]' style='color:#fff'>View Location</a> </div></div></div>";
              }
                }
            mysqli_close($con);
            ?>
