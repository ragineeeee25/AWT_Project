...
<html>
   ...
   <body>
      ...
      <header id="header" class="alt" >
         <div class="logo"><a href="index.php"><span>Artistic Lane</span></a></div>
      ...
      <footer id="footer">
         ...
         <div class="copyright">
            <div class="footer text-center">Design & Develop By Group 13 | Mini Project Trimester 9</div>
