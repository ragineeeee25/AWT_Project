...
<div class="divform">
	<h2><span class="glyphicon glyphicon-log-in"></span> Customer Login</h2>
                 <img src="img/customer.jpg" Align="right" width="350" height="300" style=" margin-bottom: 40px; margin-right: 20%">
	<form action="index.php?page=customer_login" method="post" name="f1">

		<div class="form-group">
			<label for="id">Email Id:</label>
			<input type="text" class="form-control" id="id" name="id" placeholder="Enter Id" style="width: 300px;">
		</div>
		<div class="form-group">
			<label for="pwd">Password:</label>
			<input type="password" class="form-control" id="pwd" name="pass" placeholder="Enter password" style="width: 300px;">
		</div>
